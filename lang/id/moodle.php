...
/**
 * Strings for component 'moodle', language 'id', version '3.11'.
 *
 * @package     moodle
 * @category    string
...
$string['cookiesenabled_help'] = 'Dua kuki digunakan pada situs ini: Yang penting adalah kuki sesi, biasanya disebut MoodleSession. Anda harus membiarkan kuki ini di peramban Anda untuk memberikan kontinuitas dan mempertahankan login Anda dari halaman ke halaman. Ketika Anda keluar atau menutup kuki peramban ini dihapus (di peramban Anda dan di server). Kuki lainnya adalah murni untuk kenyamanan, biasanya dinamakan seperti MOODLEID. Ini hanya pengingat nama pengguna Anda di peramban. Ini berarti ketika Anda kembali ke situs ini kolom nama pengguna pada halaman login akan sudah diisi untuk Anda. Aman untuk menolak kuki ini - Anda hanya perlu mengetik ulang nama pengguna Anda setiap kali Anda masuk.';
$string['cookiesenabledonlysession'] = 'Kuki harus diaktifkan pada peramban Anda';
$string['cookiesenabledonlysession_help'] = 'Situs ini menggunakan satu kuki sesi, biasanya disebut MoodleSession. Anda harus mengizinkan kuki ini di browser Anda untuk memberikan kontinuitas dan tetap masuk saat menelusuri situs. Saat Anda keluar atau menutup peramban, kuki ini dihancurkan (di peramban Anda dan di server).';
...
$string['courseduration_desc'] = 'Durasi kursus digunakan untuk menghitung tanggal akhir kursus default. Tanggal akhir kursus digunakan untuk menentukan apakah suatu kursus harus dimasukkan dalam daftar kursus pengguna. Ini juga dapat digunakan oleh laporan tersuai. Pengguna masih dapat mengikuti kursus setelah tanggal berakhir.';
...
$string['databaseupgradelocal'] = 'Versi basis data lokal tersuai adalah {$a}';
...
$string['emailconfirmation'] = 'Hallo,
...
$string['emaildisplayhide'] = '(Disembunyikan dari pengguna yang tidak berhak)';
...
$string['idnumbermod_help'] = 'Menetapkan nomor ID menyediakan cara mengidentifikasi aktivitas atau sumber daya untuk tujuan seperti penghitungan tingkat atau pelaporan tersuai. Kalau tidak, bidang tersebut dapat dibiarkan kosong. Untuk aktivitas bertahap, nomor ID juga dapat diatur dalam buku nilai, meskipun hanya dapat diedit pada halaman setelan aktivitas.';
...
$string['modvisible_help'] = 'Jika ketersediaan diatur ke \'Tampilkan halaman kursus\', aktivitas atau sumber tersedia untuk siswa (tunduk pada batasan akses yang mungkin diatur).

 Jika ketersediaan diatur ke \'Sembunyikan dari siswa\' , aktivitas atau sumber daya hanya tersedia bagi pengguna dengan izin untuk melihat aktivitas tersembunyi (secara bawaan, pengguna dengan peran pengajar atau pengajar noneditor).';
$string['modvisiblehiddensection'] = 'Ketersediaan';
$string['modvisiblehiddensection_help'] = 'Jika ketersediaan diatur ke \'Sembunyikan dari siswa\', aktivitas atau sumber hanya tersedia bagi pengguna yang memiliki izin untuk melihat aktivitas tersembunyi (secara default, pengguna dengan peran pengajar atau pengajar noneditor).

Jika kursus berisi banyak aktivitas atau sumber daya, halaman kursus mungkin disederhanakan dengan mengatur ketersediaan \'Tersedia tapi tidak ditampilkan pada halaman kursus\'. Dalam kasus ini, tautan ke aktivitas atau sumber daya harus disediakan dari tempat lain, seperti dari sumber halaman. Aktivitas tersebut masih akan tercantum dalam buku nilai dan laporan lainnya.';
$string['modvisiblewithstealth'] = 'Ketersediaan';
$string['modvisiblewithstealth_help'] = 'Jika ketersediaan diatur ke \'Tampilkan pada halaman kursus\', aktivitas atau sumber tersedia bagi siswa (tunduk pada pembatasan akses yang mungkin ditetapkan).

Jika ketersediaan diatur ke \'Sembunyikan dari siswa\' , aktivitas atau sumber hanya tersedia bagi pengguna yang memiliki izin untuk melihat aktivitas tersembunyi (secara default, pengguna dengan peran pengajar atau pengajar noneditor).

Jika kursus berisi banyak aktivitas atau sumber, kursus halaman dapat disederhanakan dengan mengatur ketersediaan ke \'Buat tersedia tapi tidak ditampilkan pada halaman kursus\'. Dalam kasus ini, tautan ke aktivitas atau sumber daya harus disediakan dari tempat lain, seperti dari sumber halaman. Aktivitas tersebut masih akan tercantum dalam buku nilai dan laporan lainnya.';
$string['month'] = 'Bulan';
$string['months'] = 'Bulan';
$string['moodledocs'] = 'Dokumen Moodle';
$string['moodledocslink'] = 'Bantuan dan dokumentasi';
...
$string['showactivitydates_help'] = 'Tanggal aktivitas selalu ditampilkan di halaman aktivitas. Setelan ini menentukan apakah tanggal aktivitas juga ditampilkan di bawah setiap aktivitas di halaman kursus.';
