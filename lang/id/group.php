...
/**
 * Strings for component 'group', language 'id', version '3.11'.
 *
 * @package     group
 * @category    string
...
$string['defaultgrouping'] = 'Pengelompokan default';
$string['defaultgroupingname'] = 'Pengelompokan';
$string['defaultgroupname'] = 'Grup';
$string['deleteallgroupings'] = 'Hapus semua pengelompokan';
$string['deleteallgroups'] = 'Hapus semua grup';
...
$string['deleteselectedgroup'] = 'Hapus grup yang dipilih';
...
Catatan: Kunci pendaftaran grup harus diaktifkan dalam pengaturan pendaftaran mandiri dan kunci pendaftaran untuk kursus juga harus ditentukan.';
