...
/**
 * Strings for component 'zoom', language 'id', version '3.11'.
 *
 * @package     zoom
 * @category    string
...
$string['audio_voip'] = 'Hanya suara komputer';
$string['audiodefault'] = 'Suara bawaan';
$string['authentication'] = 'Autentikasi';
$string['calendardescriptionURL'] = 'URL gabung rapat: {$a}.';
...
$string['encryptiontype'] = 'Tipe enkripsi';
$string['end_date_option_after'] = 'Setelah';
$string['enddate'] = 'Tanggal berakhir';
...
$string['joinlink'] = 'Tautan bergabung';
$string['media'] = 'Media';
...
$string['meetingcapacitywarning'] = 'Peringatan kapasitas pertemuan/rapat';
$string['off'] = 'Padam';
$string['on'] = 'Menyala';
...
$string['recreatesuccessful'] = 'Membuat kembali pertamuan/rapat berhasil';
$string['recurringmeetingexplanation'] = 'Pertemuan/rapat ini tidak memiliki tenggat waktu';
...
$string['setpasscode'] = 'Atur kode akses';
$string['start'] = 'Mulai';
...
$string['supplementaryfeaturessettings_desc'] = 'Setelan ini mengontrol apakah dan bagaimana fitur Zoom yang diberikan kepada pengguna.';
$string['title'] = 'Judul';
$string['topic'] = 'Topik';
$string['unavailable'] = 'Anda tidak dapat bergabung pada saat ini.';
$string['unavailablefinished'] = 'Pertemuan/rapat sudah selesai.';
$string['unavailablefirstjoin'] = 'Anda dapat bergabung paling cepat {$a->mins} menit sebelum waktu mulai yang dijadwalkan.';
$string['unavailablenotstartedyet'] = 'Pertemuan belum dimulai.';
...
$string['webinar_alwaysshow'] = 'Selalu Tampilkan Opsi webinar tak peduli apakah pengguna memiliki lisensi untuk pembawa acara webinar';
$string['webinar_desc'] = 'Dengan setelan ini, Anda dapat mengontrol apakah opsi untuk membuat webinar ditampilkan kepada pengguna selama pembuatan pertemuan atau tidak. Pengaturan ini hanya mempengaruhi pengaturan aktivitas Moodle. Bahkan jika Anda memutuskan untuk selalu menampilkan opsi,pengguna masih membutuhkan lisensi yang valid untuk webinars akhirnya menjadi pembawa acara sebuah webinar.';
$string['webinar_disable'] = 'Nonaktifkan para webinar';
$string['webinar_showonlyiflicense'] = 'Tampilkan opsi webinar hanya jika pengguna memiliki lisensi untuk host webinar';
$string['webinarthisis'] = 'Ini adalah webinar';
$string['zoom:addinstance'] = 'Tambahkan rapat Zoom baru';
$string['zoom:refreshsessions'] = 'Segarkan laporan pertemuan/rapat Zoom';
$string['zoom:view'] = 'Lihat Zoom Meeting';
$string['zoomerr'] = 'Sebuah kesalahan terjadi dengan Zoom.';
$string['zoomerr_alternativehostusernotfound'] = 'Pengguna {$a} tidak ditemukan pada Zoom.';
$string['zoomerr_apikey_missing'] = 'Kunci API Zoom tak ditemukan';
$string['zoomerr_apisecret_missing'] = 'API rahasia Zoom tak ditemukan';
