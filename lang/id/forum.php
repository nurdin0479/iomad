...
/**
 * Strings for component 'forum', language 'id', version '3.11'.
 *
 * @package     forum
 * @category    string
...
$string['indicator:cognitivedepthdef_help'] = 'Peserta telah mencapai persentase keterlibatan kognitif ini yang ditawarkan oleh aktivitas Forum selama interval analisis ini (Levels = Tidak ada tampilan, Lihat, Ajukan, Lihat umpan balik, Komentari umpan balik, Ajukan ulang setelah melihat umpan balik)';
...
$string['postisprivatereply'] = 'Ini adalah balasan pribadi. Ini hanya dapat dilihat oleh Anda dan siapa saja yang memiliki kemampuan untuk melihat balasan pribadi, seperti pengajar atau manajer.';
...
$string['unsubscribeallempty'] = 'Anda tidak berlangganan forum mana pun. Untuk menonaktifkan semua pemberitahuan dari server ini buka Olah pesan di Pengaturan Profil Saya.';
