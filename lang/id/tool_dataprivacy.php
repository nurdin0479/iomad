...
/**
 * Strings for component 'tool_dataprivacy', language 'id', version '3.11'.
 *
...
$string['defaultswarninginfo'] = 'Peringatan: Mengubah bawaan ini dapat memengaruhi periode retensi model yang ada.';
$string['defaultunexpired'] = 'Hanya data untuk pengguna yang memegang salah satu peran berikut:<br> {$a->expired}';
$string['defaultunexpiredwithexceptions'] = 'Hanya data untuk pengguna yang memegang salah satu peran berikut: <br> {$a->expired} Kecuali mereka juga memegang salah satu peran berikut: <br> {$a->unexpired}';
...
$string['deleteexpireddatarequeststask'] = 'Hapus file ekspor permintaan data yang kedaluwarsa';
...
$string['frontpagecourse'] = 'Kursus halaman depan';
...
$string['purposedefault_help'] = 'Tujuan bawaan adalah tujuan yang diterapkan pada setiap model baru. Jika Mewarisi dipilih, tujuan dari konteks yang lebih tinggi akan diterapkan. Konteksnya adalah (dari rendah ke tinggi): Blok > Modul aktivitas > Kursus > Kategori kursus > Pengguna > Situs.';
