...
/**
 * Strings for component 'assign', language 'id', version '3.11'.
 *
 * @package     assign
 * @category    string
...
$string['allowsubmissionsanddescriptionfromdatesummary'] = 'Detail dan formulir penugasan akan tersedia dari <strong> {$a} </ strong>';
...
$string['attemptreopenmethod_help'] = 'Setelan ini menentukan apakah siswa dapat melakukan upaya tambahan pada tugas. Untuk setiap pengerjaan, nilai dan umpan balik disimpan, dan dapat dilihat oleh pengajar dan siswa. Opsi yang tersedia adalah:

* Tidak pernah - Hanya satu upaya yang mungkin.
* Secara manual - Upaya tambahan mungkin diizinkan oleh pengajar.
* Otomatis hingga lulus - Upaya tambahan diizinkan secara otomatis hingga siswa mencapai nilai untuk lulus yang ditetapkan dalam buku nilai untuk penugasan ini.';
...
$string['cutoffdate_help'] = 'Jika disetel, penugasan tidak akan menerima pengajuan setelah tanggal ini tanpa perpanjangan.';
...
$string['duedateno'] = 'Tidak ada tanggal jatuh tempo';
...
$string['indicator:cognitivedepthdef_help'] = 'Peserta telah mencapai persentase keterlibatan kognitif yang ditawarkan oleh aktivitas penugasan selama interval analisis ini (Levels = Tidak ada tampilan, Lihat, Ajukan, Lihat umpan balik, Komentari umpan balik, Ajukan ulang setelah melihat umpan balik)';
...
$string['introattachments_help'] = 'Berkas tambahan untuk digunakan dalam penugasan, seperti templat jawaban, dapat ditambahkan. Tautan unduhan untuk berkas kemudian akan ditampilkan pada halaman penugasan di bawah deskripsi.';
...
$string['submissionreceiptothertext'] = 'Pengajuan tugas untuk \'{$a->assignment}\' telah tersampaikan.
...
$string['teamsubmissiongroupingid_help'] = 'Ini adalah pengelompokan yang akan digunakan penugasan untuk menemukan grup untuk kelompok siswa. Jika tidak disetel, kumpulan grup bawaan akan digunakan.';
