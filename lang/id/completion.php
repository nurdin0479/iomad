...
/**
 * Strings for component 'completion', language 'id', version '3.11'.
 *
 * @package     completion
 * @category    string
...
$string['showcompletionconditions_help'] = 'Kondisi penyelesaian aktivitas selalu ditampilkan di halaman aktivitas. Setelan ini menentukan apakah kondisi penyelesaian aktivitas juga ditampilkan di bawah setiap aktivitas pada halaman kursus.';
