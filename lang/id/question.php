...
/**
 * Strings for component 'question', language 'id', version '3.11'.
 *
 * @package     question
 * @category    string
...
$string['addmorechoiceblanks'] = 'Kosongkan untuk {no} lebih banyak pilihan';
...
Alternatifnya, Anda mungkin ingin siswa mengirimkan setiap soal sambil berjalan untuk mendapatkan umpan balik segera, dan jika mereka tidak segera menjawabnya, coba lagi untuk mendapatkan nilai yang lebih sedikit. Itu akan menjadi mode \'Interaktif dengan beberapa percobaan\'.
...
$string['questionbehavioursdisabledexplained'] = 'Masukkan daftar yang dipisahkan dengan koma untuk sikap yang tidak ingin anda munculkan pada menu tarik-turun.';
$string['questionbehavioursorder'] = 'Susunan sikap soal';
$string['questionbehavioursorderexplained'] = 'Masukkan daftar yang dipisahkan dengan koma untuk sikap yang ingin anda munculkan pada menu tarik-turun.';
